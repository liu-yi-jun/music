...
Page({
  ...
  start() {
    ...
    this.innerAudioContext.src = 'http://eigene.cn:3000/ppp.mp3'
    this.innerAudioContext.play()
    let i = 30
    setInterval(() => {
      i--
  ...
  manyPlay() {
    ...
    innerAudioContext2.src = 'http://eigene.cn:3000/star.mp3'
    ...
    setInterval(() => {
      i--
      if (i <= 0) {
        innerAudioContext1 && innerAudioContext2.destroy()
        innerAudioContext2 && innerAudioContext2.destroy()
      }
    }, 1000);
  },
  /**
