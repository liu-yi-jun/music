// pages/square/band/momentDetail/momentDetail.js
const app = getApp()
...
Page({
  ...
  onLoad: function (options) {
    let id = options.id
    this.table = 'bandmoment'
    this.getMomentDetail(id, this.table, 'detail')
    // 获取去除上面导航栏，剩余的高度
    tool.navExcludeHeight(this)

  },
  getMomentDetail(id, table, type) {
    let commentPaging = this.data.commentPaging
    app.get(app.Api.momentDetailAndCommont, {
      id,
      ...commentPaging,
      table,
      type,
  ...
  scrolltolower() {
    if (!this.data.IsNoData) this.getMomentDetail(this.data.detail.id, this.table)
  },
  showMenu(e) {
